...
struct Z_Construct_UScriptStruct_FFluid_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_Material_MetaData[] = {
		{ "Category", "Particles|Visuel" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "//need creation of dynamic material instance to change material color\n" },
#endif
		{ "ModuleRelativePath", "FluideManager.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "need creation of dynamic material instance to change material color" },
#endif
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_RestDensity_MetaData[] = {
		...
		{ "ModuleRelativePath", "FluideManager.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Densit\xef\xbf\xbd au repos kg/m\xef\xbf\xbd \xef\xbf\xbd eau=1000, huile=870" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_TaitK_MetaData[] = {
		...
		{ "ModuleRelativePath", "FluideManager.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Constante de Tait \xef\xbf\xbd rigidit\xef\xbf\xbd du fluide" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_Viscosity_MetaData[] = {
		...
		{ "ModuleRelativePath", "FluideManager.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Viscosit\xef\xbf\xbd \xef\xbf\xbd" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_InfluenceRadius_MetaData[] = {
		...
		{ "ModuleRelativePath", "FluideManager.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Rayon d'influence h en m\xef\xbf\xbdtres" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_CrossPressureFactor_MetaData[] = {
		{ "Category", "Interaction" },
		{ "ModuleRelativePath", "FluideManager.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Facteur de pression cross-fluide. 1=neutre, >1=immiscible" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_CrossViscosityFactor_MetaData[] = {
		{ "Category", "Interaction" },
		{ "ModuleRelativePath", "FluideManager.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Facteur de viscosit\xef\xbf\xbd cross-fluide" },
#endif
	};
#endif // WITH_METADATA
	...
	static const UECodeGen_Private::FFloatPropertyParams NewProp_CrossPressureFactor;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_CrossViscosityFactor;
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FFluid_Statics::NewProp_Viscosity = { "Viscosity", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FFluid, Viscosity), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Viscosity_MetaData), NewProp_Viscosity_MetaData) };
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FFluid_Statics::NewProp_CrossPressureFactor = { "CrossPressureFactor", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FFluid, CrossPressureFactor), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CrossPressureFactor_MetaData), NewProp_CrossPressureFactor_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FFluid_Statics::NewProp_CrossViscosityFactor = { "CrossViscosityFactor", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FFluid, CrossViscosityFactor), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CrossViscosityFactor_MetaData), NewProp_CrossViscosityFactor_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FFluid_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FFluid_Statics::NewProp_CrossPressureFactor,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FFluid_Statics::NewProp_CrossViscosityFactor,
};
...
struct Z_Construct_UClass_AFluideManager_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ParticleScale_MetaData[] = {
		...
		{ "ModuleRelativePath", "FluideManager.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Taille du mesh de la particule" },
#endif
	};
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AFluideManager_Statics::NewProp_ParticleScale = { "ParticleScale", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFluideManager, ParticleScale), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ParticleScale_MetaData), NewProp_ParticleScale_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AFluideManager_Statics::NewProp_BoundsMin = { "BoundsMin", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFluideManager, BoundsMin), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BoundsMin_MetaData), NewProp_BoundsMin_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AFluideManager_Statics::NewProp_BoundsMax = { "BoundsMax", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFluideManager, BoundsMax), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BoundsMax_MetaData), NewProp_BoundsMax_MetaData) };
...
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AFluideManager_Statics::NewProp_bDebugDrawBounds = { "bDebugDrawBounds", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(AFluideManager), &Z_Construct_UClass_AFluideManager_Statics::NewProp_bDebugDrawBounds_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_bDebugDrawBounds_MetaData), NewProp_bDebugDrawBounds_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFluideManager_Statics::NewProp_BoundsDamping = { "BoundsDamping", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFluideManager, BoundsDamping), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BoundsDamping_MetaData), NewProp_BoundsDamping_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_AFluideManager_Statics::NewProp_Gravity = { "Gravity", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFluideManager, Gravity), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Gravity_MetaData), NewProp_Gravity_MetaData) };
...
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AFluideManager_Statics::NewProp_FluidISMs = { "FluidISMs", nullptr, (EPropertyFlags)0x0010008000000008, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFluideManager, FluidISMs), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_FluidISMs_MetaData), NewProp_FluidISMs_MetaData) };
...
struct Z_CompiledInDeferFile_FID_Users_AutoRazer_Documents_GitHub_MecaniqueFluide_Fluides_Source_Fluides_FluideManager_h__Script_Fluides_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FFluid::StaticStruct, Z_Construct_UScriptStruct_FFluid_Statics::NewStructOps, TEXT("Fluid"), &Z_Registration_Info_UScriptStruct_FFluid, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FFluid), 411356373U) },
	...
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AFluideManager, AFluideManager::StaticClass, TEXT("AFluideManager"), &Z_Registration_Info_UClass_AFluideManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AFluideManager), 2044620161U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_AutoRazer_Documents_GitHub_MecaniqueFluide_Fluides_Source_Fluides_FluideManager_h__Script_Fluides_1981968965(TEXT("/Script/Fluides"),
